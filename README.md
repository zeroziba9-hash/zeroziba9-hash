...
<p align="center">
  ...
  Java/Spring 기반 백엔드를 만들고, 운영/검증/문서화까지 확장하며 성장하고 있습니다.
</p>
...
- **구현 중심 → 검증 중심**: 기능 구현 후 테스트/CI로 안정성 확보
...
**Spring Boot 실시간 채팅 + 인증/권한 제어 프로젝트**
- WebSocket(STOMP) + REST 혼합 구조
- 역할 기반 접근 제어(ADMIN/MODERATOR/MEMBER/GUEST)
- 표준 API 응답/에러 스키마, CI/Runbook/Observability 정리
