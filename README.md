...
- [sql-board-reply-assignment](https://github.com/zeroziba9-hash/sql-board-reply-assignment)  
  게시판/댓글 중심 SQL 실습 프로젝트 (테이블 설계, 조인/조회, 데이터 흐름 이해)
...
- 머신러닝·딥러닝 기본 개념 및 실습 (분류/회귀, 모델 평가, 시각화)
